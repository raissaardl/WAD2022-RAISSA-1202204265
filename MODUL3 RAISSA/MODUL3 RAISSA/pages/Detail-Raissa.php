  ...
  $sql = "SELECT * FROM showroomraissa WHERE id_mobil = $id";
  ...
  <head>
    ...
    <title>Detail Car - Raissa_1202204265</title>
      ...
      <div class="container">
        ...
        while ($getDetail = mysqli_fetch_array($hasil)) {
          echo "
                  ...
                  <img style='width:650px; height:400px;' src='../asset/images/" . $getDetail["foto_mobil"] . "' alt='foto_mobil'>
