...
<head>
  ...
  <title>List - Raissa_1202202188</title>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-navbar-dark bg-<?php echo isset($_COOKIE['bg-nav'])? $_COOKIE['bg-nav'] : 'primary';?>">
    <div class="container">
      <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNavAltMarkup">
        ...
        <a href="Add-raissa.php" style="background-color: white; color:blue; border-radius: 5px; text-decoration: none; width: 150px; height: 35px; display:flex; justify-content:center; align-items:center; font-weight:500;">AddCar</a>
      </div>
    </div>
  </nav>
  <!-- Nav End -->
      ...
      <div>
        ...
        <div class="d-flex gap-5">
          ...
          if (mysqli_num_rows($hasil) > 0) {
            ...
            <img src='../asset/images/" . $row["foto_mobil"] . "' class='card-img-top' alt='foto_mobil' style='padding: 16px;'>
            <div class='card-body'>
